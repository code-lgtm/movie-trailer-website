...
ordered_list_active = '''
    <li data-target="#myCarousel" data-slide-to="{slide_number}" class="active"></li>
'''
...
inner_image_active = '''
    <div class="item active movie-tile" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal"
        data-target="#trailer">
...
inner_image= '''
    <div class="item movie-tile" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal"
        data-target="#trailer">
        <img src="{movie_poster_url}">
        <div class="carousel-caption">
            <h2>{movie_title}</h2>
...
movie_tile_content = '''
<div class="carousel" id="myCarousel" data-ride="carousel" data-interval="false">
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        if index == 0:
            ...
            img_content += inner_image_active.format(movie_poster_url=movie.poster_image_url,
                                                     trailer_youtube_id=trailer_youtube_id,
                                                     movie_title=movie.title)
        else:
            #non active carousal items
            img_content += inner_image.format(movie_poster_url=movie.poster_image_url,
                                              trailer_youtube_id=trailer_youtube_id,
                                              movie_title=movie.title)
        index += 1
